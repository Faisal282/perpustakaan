...
$dataPenjaga = tampil("SELECT * FROM penjaga ORDER BY id_penjaga ASC");
...
<html lang="en">
	<head>
		...
		<script src="js/scriptPenjaga.js"></script>
		<!-- Required meta tags-->
		<meta charset="UTF-8">
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="row m-b-25">
											<div class="col-sm-4">
												<h2 class="title-1 m-b-25">Daftar Penjaga</h2>
											</div>
											<div class="col-sm-4 offset-sm-4">
												<div class="table-data__tool-right text-right">
													<a href="tambah/tambahPenjaga.php">
														<button class="au-btn au-btn-icon au-btn--green au-btn--small">
														<i class="zmdi zmdi-plus"></i>Tambah Penjaga
														</button>
													</a>
												</div>
											</div>
												...
												<table class="table table-borderless table-striped table-earning">
													...
													<tbody>
														...
														<tr>
															...
															<td class="text-center"><a href="update/updatePenjaga.php?id_penjaga=<?= $penjaga['id_penjaga']; ?>">
																<button class='au-btn au-btn-icon au-btn--blue au-btn--small'>
																<i class='zmdi zmdi-border-color'></i>Edit
																</button>
															</a>
														</td>
														<td class="text-center"><a href="delete/deletePenjaga.php?id_penjaga=<?= $penjaga['id_penjaga'];?>" onclick="return confirm('Apakah Anda Yakin Menghapus')">
